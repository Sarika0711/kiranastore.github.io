	...
	';
		...
		$output .= '
			<tr>  
             ...
             $output .= '              
                          <tr>   
                               <td colspan="4" align="center"class="text-primary">Name:'.$_SESSION['Uname'].'</td> 
                      ...
                      ';      
                       ...
                       if(isset($_SESSION['Uadd']))
                       {
             $output .= '              
                          <tr>   
                               <td colspan="4" align="center"class="text-primary">Address:'.$_SESSION['Uadd'].'</td> 
...
if(isset($_POST["action"]))
{
	...
	$mail->Username = 'nikamsarika0711@gmail.com';					//Sets SMTP username
	$mail->Password = 'fxqtywchbgqsblco';					//Sets SMTP password
	$mail->SMTPSecure = 'tls';							//Sets connection prefix. Options are "", "ssl" or "tls"


	$email=$_POST['email'];
	$mail->From = '$email';			//Sets the From email address for the message
	$mail->FromName = 'sarika nikam';			//Sets the From name of the message
        
   
   	$mail->AddAddress('bhagtkirana1998@gmail.com', 'Bhagt Nikam');		//Adds a "To" address
...
<html>
	...
	<body>
		<br />
		<div class="container">
			<h3 align="center"><strong>Final Order Details</strong></h3>
			<br />
			<form method="post" action=" ">
