...
<div class="container">
    ...
    <input type="text" class="form-control" placeholder="Enter name" name="name" style="width: 200px;"required>
    <label for="pwd">Password:</label>
    <input type="password" class="form-control"  placeholder="Enter password" name="pass"  style="width: 200px;"required>
    <label for="date">DATE:</label>
    <input type="date" class="form-control" placeholder="Enter date" name="date"  style="width: 200px;"required>
    <br>
    
    <input type="submit"name="submit" class="btn btn-info" value="ORDER FROM MANIK STORE">
     <input type="submit" class="btn btn-info"  name="submit1" value="ORDER FROM RAJUDADA STORE">
     
     <input type="submit" class="btn btn-info" name="submit2" value="ORDER FROM BHAGAT STORE">
