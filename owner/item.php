	...
	<div class="container-fluid">
			...
			<div class="col-lg-4  col-md-4 col-sm-12 col-12">
				...
				<div class="card-body  text-center">
					...
					<a href="addother.php" class="btn btn-danger text-center">ADD</a>
			...
			<div class="col-lg-4  col-md-4 col-sm-12 col-12">
				...
				<div class="card-body  text-center">
					...
					<a href="addother.php" class="btn btn-danger text-center">CLICK</a>
			...
			<div class="col-lg-4  col-md-4 col-sm-4 col-12">
				...
				<div class="card-body  text-center">
					...
					<a href="addbeauty.php" class="btn btn-danger text-center">CLICK</a>
...
<div class="row">
			<div class="col-lg-4  col-md-4 col-sm-12 col-12">
				...
				<div class="card-body  text-center">
					...
					<a href="addcl.php" class="btn btn-danger text-center">ADD</a>
			...
			<div class="col-lg-4  col-md-4 col-sm-12 col-12">
				...
				<div class="card-body  text-center">
					...
					<a href="addcol.php" class="btn btn-danger text-center">CLICK</a>
			...
			<div class="col-lg-4  col-md-4 col-sm-4 col-12">
				...
				<div class="card-body  text-center">
					...
					<p class="card-text text-center" >Lets see our services and consultancy</p>
					<a href="index.html" class="btn btn-danger text-center">CLICK</a>
